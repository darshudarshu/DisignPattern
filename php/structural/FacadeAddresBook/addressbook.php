<?php
/***********************************************************************************
 * @description : (FACADE DESIGN PATTERN) type ADDRESS BOOK
 * program that can be used to maintain an address book. An address book
 ...
 */
    ...
    {
        if (UtilityAdd::searchAddress()) {
            UtilityAdd::displaySpecificPerson($this->index);
            do {
                echo "---------------------------------\n";
                ...
                echo "ENTER 5 : To Exit from edit operation \n";
                echo "---------------------------------\n";
                ...
                echo "********Address is EDITED successfully*********\n";
                echo "-------------------------------\n";
    ...
    public function removeAddres()
    {
        do {
            ...
            if (UtilityAdd::searchAddress()) {
                ...
                echo "*******This address is DELETED Permanently*******\n";
            } else {
                echo "No such name address is found \n";
                //recursion
                $this->removeAddres();
 ...
 */
class OpenBook extends UtilityAdd
{
    public function phoneBookDisplay()
    {
        ...
        for ($i = 0; $i < count($json_arr); $i++) {
            ...
            UtilityAdd::displaySpecificPerson($i);
            echo "\n";
        }
    }
}
 ...
 * which has a method to interact with different proccess according to cleint request
 */
class FacadeAddress
{
    ...
    public function searchAddress()
    {
        ...
        for ($i = 0; $i < count($json_arr); $i++) {
            ...
            if ($json_arr[$i]["firstName"] == $name) {
                echo "ENTER " . $i . " to choose this adress \n";
